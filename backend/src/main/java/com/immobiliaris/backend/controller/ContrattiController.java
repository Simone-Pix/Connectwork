...
public class ContrattiController {
    ...
    // 3️ Recupera contratti per ID immobile
    ...
    // 4️ Recupera contratti per proprietario
    ...
    // 6️ Aggiorna un contratto esistente
    @PutMapping("/{id}")
